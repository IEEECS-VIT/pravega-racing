...
window.keyshotXR = function (
  ...
  function P(a, d, b) {
    a.removeEventListener
      ? a.removeEventListener(d, b, u)
      : a.detachEvent &&
        (a.detachEvent('on' + d, a['e' + d + b]), (a['e' + d + b] = t));
  }
  function k(a, d, b) {
    a.addEventListener
      ? a.addEventListener(d, b, u)
      : a.attachEvent &&
        ((a['e' + d + b] = b),
  ...
  function R(f) {
    a.ab &&
      ((f = f ? f : window.event),
      a.Ha(0 < (f.detail ? -1 * f.detail : f.wheelDelta / 40) ? 1 : -1),
      qa(f));
  }
  function la(f) {
    f || (f = window.event);
      ...
      (1 == j.d
        ? 0.01 < i.L
          ? ((i.b.x = 0.4 * (l.a.x - i.a.x)),
            ...
            (i.a.y += i.b.y),
            a.na(i.b.x, i.b.y))
          : (a.na(l.b.x, l.b.y), (l.b.x = 0), (l.b.y = 0))
        : 0.01 < i.L &&
          ((i.b.x *= i.L),
          (i.b.y *= i.L),
        ...
        void 0 !== r &&
          ...
          !b && void 0 == r[b]
            ? document.getElementById('xr_hotspot') &&
              ((d = document.getElementById('xr_hotspot')),
            ...
            : (document.getElementById('xr_hotspot') &&
              ...
              void 0 !== r[b].hb &&
                (r[b].options.fontSize &&
                  (d.style.fontSize = r[b].options.fontSize),
                r[b].options.Ia && (d.style.color = r[b].options.Ia),
                r[b].options.bgColor &&
                  (d.style.backgroundColor = r[b].options.bgColor),
                r[b].options.link && (d.href = r[b].options.link),
                r[b].options.height && (d.style.height = r[b].options.height),
                r[b].options.width && (d.style.width = r[b].options.width),
                r[b].options.textAlign &&
                  (d.style.textAlign = r[b].options.textAlign)),
              document.body.appendChild(d)));
      }
    }
    if (c.n != c.a || c.j != c.xa || c.k != c.ya)
      (c.a = c.n), (c.xa = c.j), (c.ya = c.k), na();
  };
  this.eb = function (b) {
    for (
      var d = -1e3,
  ...
  if (document.createElement('canvas').getContext) {
    ...
    for (D = 0; D < w.length; D++)
      'undefined' !=
        ...
        ((z = '-' + w[D].toLowerCase() + '-'), (M = w[D] + 'Transform'));
    var b = '';
