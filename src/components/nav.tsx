        ...
        <div className='flex items-center justify-between h-20'>
          ...
          <div className='hidden sm:block' style={{ marginTop: '29.4px' }}>
            <div className='flex space-x-4'>
              <Link href='/' passHref>
                <p className='text-white hover:text-gray-300 px-3 py-2 rounded-md text-[2.5vh] font-medium cursor-pointer'>
                  Home
                </p>
              </Link>
              <div className='relative group'>
                ...
                <div className='absolute z-10 hidden bg-black bg-opacity-90 text-white group-hover:block w-48 py-2 rounded-md'>
                  <Link
                    ...
                    passHref
                  >
                    <p className='block px-4 py-2 cursor-pointer hover:text-gray-300'>
                      PRV Delta Phoenix
                    </p>
                  </Link>
                  <Link
