    ...
    <div>
      ...
      <div
          ...
          <div className="w-full p-4">
            <div className="mx-auto max-w-3xl">
              <div className="w-full bg-gray-50 p-4 mb-6">
                <h1 className="text-2xl font-bold text-center mb-6">Pravega Racing</h1>
                <div className="flex flex-col lg:flex-row gap-4">
                  <div className="w-full lg:w-1/2 mb-4 lg:mb-0">
                    <div className="bg-gray-800 text-white text-center w-full p-2.5 text-sm mb-2">
                ...
                <div className='flex flex-col sm:flex-row mt-4 gap-4'>
                  <div className="w-full sm:w-1/2 flex flex-col">
                    <a className='text-sm flex items-center pb-1 text-blue-800'>
                      ...
                      <p className="ml-2">pravegaracing@vit.ac.in</p>
                    </a>
                    <a className='text-sm flex items-center pb-1 text-blue-800' href="http://www.pravega-racing.com">
                      ...
                      <p className="ml-2">www.pravega-racing.com</p>
                    </a>
                    <a className='text-sm flex items-center pb-1 text-blue-800' href="http://www.pravega-racing.com">
                      <i className="fa fa-facebook w-5 text-center"></i>
                      <p className="ml-2">/pravegaracing</p>
                    </a>
                  </div>
                ...
                <div className="flex justify-center items-center mt-6">
                  ...
                  <span className="text-sm ml-2">VIT University, Vellore-632014, India</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-center items-start px-4 md:px-8 lg:px-48 mb-10 gap-8">
          <div className="w-full lg:w-1/2">
            <h3 className="mb-5 text-xl font-bold">Leave us a message</h3>
