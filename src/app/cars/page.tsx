              ...
              <SwiperSlide key={index}>
                ...
                <div className="container mx-auto" style={{ height: '100%', display: 'flex', flexDirection: 'row', gap: '10px', width: '80%' }}>
                  <div className="textContentCars">
                    <b>Weight:</b> {car.Weight}<br />
                    <b>Wheelbase:</b> {car.Wheelbase}<br />
                    <b>Suspension:</b> {car.Suspension}<br />
                    <b>Dampers:</b> {car.Dampers}<br />
                    <b>Brakes type:</b> {car.BrakesType}<br />
                    <b>Chassis:</b> {car.Chassis}<br />
                    <b>Wheels:</b> {car.Wheels}<br />
                    <b>Tires Dry:</b> {car.TiresDry}<br />
                    <b>Tires Wet:</b> {car.TiresWet}<br />
                  ...
                  <div style={{ width: '55%' }}>
                    <img src={car.Image} style={{ height: '70%', width: '100%' }} />
                  </div>
                </div>
              </SwiperSlide>
