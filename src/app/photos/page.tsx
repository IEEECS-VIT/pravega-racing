...
const imageData = {
  'Formula Student Germany 2023': generateImagePaths(
    15,
    '/images/general/media/fsg23',
  ), // Adjust the count as needed
  'Formula Student East 2023': generateImagePaths(
    15,
    '/images/general/media/fse23',
  ), // Adjust the count as needed
  'Formula Bharat 2023': generateImagePaths(15, '/images/general/media/fb23'),
  'Formula Student Germany 2019': generateImagePaths(
    12,
    '/images/general/media/fsg19',
  ),
  ...
  'Formula SAE Australasia 2018': generateImagePaths(
    6,
    '/images/general/media/fSAE',
  ),
  'Formula Student Germany 2017': generateImagePaths(
    8,
    '/images/general/media/fsg17',
  ),
  'Grand Rollout 2017': generateImagePaths(
    6,
    '/images/general/media/rollout17',
  ),
  ...
  'Formula Student India 2016': generateImagePaths(
    7,
    '/images/general/media/fsi16',
  ),
  'Formula Student India 2015': generateImagePaths(
    7,
    '/images/general/media/fsi15',
  ),
  'Formula Student Germany 2016': generateImagePaths(
    9,
    '/images/general/media/fsg16',
  ),
  'Formula Student Germany 2015': generateImagePaths(
    8,
    '/images/general/media/fsg15',
  ),
  'Formula Student Germany 2014': generateImagePaths(
    10,
    '/images/general/media/fsg14',
  ),
};
