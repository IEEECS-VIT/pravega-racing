      ...
      >
        <div className='w-full grid-rows-1 bg-white grid-cols-1 gap-4 '>
          <div className='col-span-1 flex flex-col items-center w-full '>
            <div className='bg-white p-20 max-w-5xl mx-auto '>
              <div className=' p-10 ' style={{ color: '#303030' }}>
                <h2 className='text-3xl font-bold flex items-center justify-center h-5/6'>
                  <span
            ...
            <div className='absolute inset-0 flex items-center justify-center bg-opacity-50  bg-black text-white'>
              <div className=' w-full h-full flex items-center justify-center'>
                <div className='text-white items-center justify-center text-3xl flex flex-col'>
                  <div>
                    How to <span style={{ color: '#DC092F' }}>Support Us </span>
                    ?
                  </div>
                  <p className='text-xl p-3 text-center mt-2'>
              ...
              <div className=' w-full h-full flex items-center justify-center'>
                <table className='table-auto text-sm text-center w-full border-separate border-spacing-x-8 border-spacing-y-6'>
                  <tbody>
                    <tr>
                      <td
                        className='border-transparent p-1 text-white w-1/5'
                        style={{ backgroundColor: '#98091F' }}
                      >
                        Material
                      </td>
                      <td
                        className='border-transparent p-1 text-white  w-4/5'
                        style={{ backgroundColor: '#303030' }}
                      >
                        Supplier of parts useful in the building of a formula
                        prototype racecar2
                      </td>
                    </tr>
                    <tr>
                      <td
                        className='border-transparent p-1 text-white '
                        style={{ backgroundColor: '#98091F' }}
                      >
                        Knowledge
                      </td>
                      <td
                        ...
                        style={{ backgroundColor: '#303030' }}
                      >
                        Specialist on a related topic and can support with time
                        and knowledge
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td
                        ...
                        style={{ backgroundColor: '#303030' }}
                      >
                        Provide tools or machines needed for the manufacturing
                        of special parts
                      </td>
                    </tr>
                    <tr>
          ...
          <div className='flex m-20 p-4'>
            <div
              className='  w-1/3 flex items-center justify-center text-4xl font-bold'
              style={{ color: '#DC092F', margin: '10px' }}
            >
              Benefits ?
            </div>
          ...
          >
            <div className='flex items-center justify-between p-4'>
              <div className=' text-white p-6 w-1/2 h-64'>
                <h2 className='text-3xl font-bold text-white flex items-center justify-center h-5/6'>
                  <span
                    className='text-3xl font-bold '
                    style={{ color: '#DC092F', marginRight: '10px' }}
                  >
                  ...
                  to be a part of Pravega Racing?
                </h2>
              </div>
                  ...
                  <li className='flex '>
                    <h2 className=' flex text-2xl text-white custom-marker'>
                      ...
                      <a
                        ...
                        onMouseEnter={(e) =>
                          (e.currentTarget.style.color = '#DC092F')
                        }
